...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(180, 10, 351, 27))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.pushButton_archivos = QtWidgets.QPushButton(self.widget)
        self.pushButton_archivos.setObjectName("pushButton_archivos")
        self.horizontalLayout.addWidget(self.pushButton_archivos)
        self.pushButton_modificar = QtWidgets.QPushButton(self.widget)
        ...
        self.label_busc_2 = QtWidgets.QLabel(self.widget1)
        self.label_busc_2.setObjectName("label_busc_2")
        self.horizontalLayout_5.addWidget(self.label_busc_2)
        self.pushButton_modo_2 = QtWidgets.QPushButton(self.widget1)
        self.pushButton_modo_2.setObjectName("pushButton_modo_2")
        self.horizontalLayout_5.addWidget(self.pushButton_modo_2)
        self.widget2 = QtWidgets.QWidget(Form)
        self.widget2.setGeometry(QtCore.QRect(0, 70, 301, 217))
        ...
        self.widget3.setGeometry(QtCore.QRect(310, 80, 261, 196))
        ...
        self.label_busd = QtWidgets.QLabel(self.widget3)
        ...
        self.label_OUT = QtWidgets.QLabel(self.widget3)
        ...
        self.label_A = QtWidgets.QLabel(self.widget3)
        ...
        self.label_ALU = QtWidgets.QLabel(self.widget3)
        ...
        self.label_B = QtWidgets.QLabel(self.widget3)
        ...
        self.label_PC = QtWidgets.QLabel(self.widget3)
        ...
        self.label_AR = QtWidgets.QLabel(self.widget3)
        ...
        self.label_IR = QtWidgets.QLabel(self.widget3)
        ...
        self.label_busc = QtWidgets.QLabel(self.widget3)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_modo_2.setText(_translate("Form", "PASO"))
